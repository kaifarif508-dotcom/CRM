      ...
      >
        ...
        <div className="flex gap-3">
          <button
            ...
            className="bg-indigo-600 px-4 py-2 rounded-lg shadow-md hover:bg-indigo-700 hover:scale-105 transition-transform"
          >
            + Add Lead
          </button>

          <button className="bg-blue-500 px-4 py-2 rounded-lg shadow-md hover:bg-blue-600 hover:scale-105 transition-transform">
            🤖 AI Assist
          </button>
        </div>
      </motion.div>
